...
export const addToHashCache = async (
  hashKey: string,
  hashValue: unknown,
...
export const addHashListCache = async (
  hashKey: string,
  listIndex: string,
  listValue: unknown,
  expirationTime: number,
...
export const getHashWithIndexCache = async <T>(
  hashKey: string,
  listIndex: string,
): Promise<T> => {
...
export const addToListCache = async (
  listKey: string,
  listValue: unknown,
  expirationTime: number,
): Promise<void> => {
...
export const getMultipleFromHashCache = async <T>(
  baseKey: string,
  subKeys: string[],
): Promise<T[]> => {
  const results: T[] = [];
...
export const addToListWithScore = async (
  listKey: string,
