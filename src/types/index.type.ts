...
export type TInferSelectNotification = InferSelectModel<
...
export type TProfile = {
  fullName: TInferSelectUserProfile["fullName"];
  bio: TInferSelectUserProfile["bio"];
  profilePic: TInferSelectUserProfile["profilePic"];
  gender: TInferSelectUserProfile["gender"];
  isBan: TInferSelectUserProfile["isBan"];
} | null;
...
export type TPostWithRelations = {
  ...
  comments?: {
    comment: {
      id: TSelectComment["id"];
      createdAt: TSelectComment["createdAt"];
      updatedAt: TSelectComment["updatedAt"];
      text: TSelectComment["text"];
      authorId: TSelectComment["authorId"];
    };
  }[];
  likes?: {
    user: {
...
export type TFollowingsPost = {
  id: TInferSelectPost["id"];
  userId: TInferSelectPost["userId"];
  text: TInferSelectPost["text"];
  image: TInferSelectPost["image"];
  createdAt: TInferSelectPost["createdAt"];
  updatedAt: TInferSelectPost["updatedAt"];
  comments: TInferSelectPostComment[];
  likes: TInferSelectPostLike[];
  tags: Pick<TInferSelectTag, "tag">[] | null;
  user: TInferSelectUserNoPass;
};
...
export type TRepliesRelations = {
  id: TInferSelectReplies["id"];
  commentId: TInferSelectReplies["commentId"];
  authorId: TInferSelectReplies["authorId"];
  text: TInferSelectReplies["text"];
  createdAt: TInferSelectReplies["createdAt"];
  updatedAt: TInferSelectReplies["updatedAt"];
  author: {
    id?: TInferSelectUser["id"];
    username?: TInferSelectUser["username"];
    email?: TInferSelectUser["email"];
