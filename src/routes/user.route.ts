...
router.put(
  "/me",
  [isAuthenticated, validationMiddleware(insertProfileBody)],
  updateProfileInfo,
);
...
router.patch(
  "/account",
  [isAuthenticated, validationMiddleware(insertAccountBody)],
  updateAccountInfo,
);

router.patch(
  "/account/password",
  [isAuthenticated, validationMiddleware(insertPasswordBody)],
  updateAccountPassword,
);
